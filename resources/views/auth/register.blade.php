    ...
    <div class="w-6/12 bg-white p-6 rounded-lg">
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_conformation" id="password_conformation" placeholder="Repeat your password" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value=""/>
            </div>
